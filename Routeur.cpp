...
{
    std::cout << "[DEBUG] Création d'un Routeur avec : " << std::endl;
    std::cout << "Nom : " << p_nom << ", Adresse IP : " << p_adresseIP << ", Localisation : " << p_localisation << std::endl;

    PRECONDITION(validerAdresseIP(p_adresseIP));
    std::cout << "[DEBUG] Adresse IP valide : " << p_adresseIP << std::endl;

    PRECONDITION(!p_nom.empty());
    std::cout << "[DEBUG] Nom non vide : " << p_nom << std::endl;

    PRECONDITION(!p_localisation.empty());
    std::cout << "[DEBUG] Localisation non vide : " << p_localisation << std::endl;
